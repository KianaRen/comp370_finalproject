...
all_articles = []
page = 206 #last collected to page 205
...
with open("trudeau_articles_page206.json", "w", encoding="utf-8") as f:
    json.dump(all_articles, f, indent=4)

print(f"\nFinished! Saved {len(all_articles)} articles to trudeau_articles_page206.json")
